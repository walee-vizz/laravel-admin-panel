<div id="billing-details" class="d-none">
    <div class="card mb-4">
        <!-- Current Plan -->
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <button class="btn btn-primary me-2 mt-2" data-bs-toggle="modal"
                        data-bs-target="#pricingModal">Upgrade
                        Plan</button>
                ...
                <div class="col-md-6">
                    <form id="creditCardForm" class="row g-3" onsubmit="return false">
                        ...
                        <div class="col-6 col-md-3">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="text" id="paymentCvv" class="form-control cvv-code-mask" maxlength="3"
                                    placeholder="654" />
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form id="formAccountSettings-2" onsubmit="return false">
                <div class="row">
                    ...
                    <div class="mb-3 col-sm-6">
                        ...
                        <select id="country-1" class="form-select select2" name="country-1">
